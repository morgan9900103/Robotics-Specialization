...
% YOUR CODE HERE
sample_pts(:,3) = 1;
warped_pts_homo = (H*sample_pts')';
warped_pts_homo(:,1) = warped_pts_homo(:,1)./warped_pts_homo(:,3);
warped_pts_homo(:,2) = warped_pts_homo(:,2)./warped_pts_homo(:,3);
warped_pts = warped_pts_homo(:,[1:2]);
end
